import { BlueskyIcon, CalendarIcon, GitHubIcon, TwitterIcon } from './Icons'
  ...
  return (
    <div class="sm:px-2 pt-6 space-y-6">
      <div class="space-y-2 sm:columns-1">
        <p class="max-w-sm">Find free lectures from leading universities and institutions near or around London</p>
        <div class="w-full flex flex-wrap gap-3 pb-2">
          <ButtonLink icon={<CalendarIcon />} rel="noopener noreferrer" target="_blank" href="/calendar.ics">
            Calendar
          </ButtonLink>
